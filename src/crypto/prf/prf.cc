...
bool MasterSecretFromPreMasterSecret(uint8_t master[48], TLSVersion version,
  ...
  switch (version) {
    case TLSv10:
    case TLSv11:
      MasterSecretFromPreMasterSecret(master, PRF10, premaster, premaster_len, client_random, server_random);
      return true;
    case TLSv12:
      MasterSecretFromPreMasterSecret(master, PRF12, premaster, premaster_len, client_random, server_random);
      return true;
    case SSLv3:
    default:
      return false;
