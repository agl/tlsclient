...
static const HandshakeMessage kPermittedHandshakeMessagesPerState[][2] = {
  ...
  /* RECV_SNAP_START_RESUME_RECOVERY_SERVER_HELLO_DONE */ { SERVER_HELLO_DONE, INVALID_MESSAGE },
...
static const HandshakeState kNextState[] = {
  ...
  /* RECV_CHANGE_CIPHER_SPEC */ { RECV_CHANGE_CIPHER_SPEC },
  ...
  /* RECV_SNAP_START_CERTIFICATE */ { RECV_SNAP_START_SERVER_HELLO },
  /* RECV_SNAP_START_SERVER_HELLO_DONE */ { RECV_SNAP_START_CHANGE_CIPHER_SPEC },
  /* RECV_SNAP_START_CHANGE_CIPHER_SPEC */ { RECV_SNAP_START_FINISHED },
  /* RECV_SNAP_START_FINISHED */ { AWAIT_HELLO_REQUEST },

  /* RECV_SNAP_START_RECOVERY_CERTIFICATE */ { RECV_SNAP_START_SERVER_HELLO_DONE },
  /* RECV_SNAP_START_RECOVERY_SERVER_HELLO_DONE */ { SEND_SNAP_START_RECOVERY_CHANGE_CIPHER_SPEC_REVERT },
  /* SEND_SNAP_START_RECOVERY_CHANGE_CIPHER_SPEC_REVERT */ { SEND_SNAP_START_RECOVERY_FINISHED },
  /* SEND_SNAP_START_RECOVERY_FINISHED */ { SEND_SNAP_START_RECOVERY_RETRANSMIT },
  /* SEND_SNAP_START_RECOVERY_RETRANSMIT */ { RECV_SNAP_START_RECOVERY_CHANGE_CIPHER_SPEC },
  ...
  /* RECV_SNAP_START_RESUME_RECOVERY_SERVER_HELLO_DONE */ { RECV_SNAP_START_RESUME_RECOVERY_CHANGE_CIPHER_SPEC },
